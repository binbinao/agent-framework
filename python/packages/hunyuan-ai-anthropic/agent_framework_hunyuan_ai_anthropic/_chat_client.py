...
class HunyuanAnthropicChatOptions(AnthropicChatOptions[TResponseModel], Generic[TResponseModel], total=False):  # type: ignore[call-arg, misc]
...
class HunyuanAnthropicClient(AnthropicClient[THunyuanAnthropicChatOptions]):  # type: ignore[misc]
